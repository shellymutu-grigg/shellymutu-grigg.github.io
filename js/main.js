      ...
      '<ul>',
          ...
          '<!-- First Tier Drop Down -->',
            '<ul>', 
              ...
              '<li><a href="sprint5-technical.html">Sprint 05 Technical</a></li>',
            '</ul>',        
          '</li>',
          ...
          '<!-- First Tier Drop Down -->',
            '<ul>',
              ...
              '<li><a href="sprint4-cultural.html">Sprint 04 Cultural</a></li>',
              '<li><a href="sprint5-cultural.html">Sprint 05 Cultural</a>',
            '</li>',
          '</ul>',
          '</li>',
      ...
      '<ul>',
        ...
        '<!-- First Tier Drop Down -->',
          '<ul>', 
            ...
            '<li><a href="blog/sprint5-technical.html">Sprint 05 Technical</a></li>',
          '</ul>',        
        '</li>',
        '<li><a href="#">Cultural Blogs</a>',
        '<!-- First Tier Drop Down -->',
          '<ul>',
            ...
            '<li><a href="blog/sprint4-cultural.html">Sprint 04 Cultural</a></li>',
            '<li><a href="blog/sprint5-cultural.html">Sprint 05 Cultural</a>',
          '</li>',
        '</ul>',
        '</li>',
        '<li><a href="#">Contact</a></li>',
